...
{{ include "rancher-demo.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "rancher-demo.selectorLabels" -}}
...
*/}}
{{- define "rancher-demo.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "rancher-demo.fullname" .) .Values.serviceAccount.name }}
{{- else }}
